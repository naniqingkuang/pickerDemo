...
@implementation UIImage (PhotoCompress)
+ (UIImage *)scaleToSize:(UIImage *)img size:(CGSize)size{
    return [img scaleToSize:size];
}
...
//缩放的UIImage类别方法如下，调用UIImage的原生方法实现的
